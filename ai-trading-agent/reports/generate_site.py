...
def _render_base(report: dict) -> str:
    ...
    pulse_html = pulse_html.replace("<span class='muted'>researched candidates</span>", "<span class='muted'>researched candidates</span><strong class='next-scan'>Next scan · 12:00 PM</strong>")
...
.mock-topbar{display:flex;justify-content:space-between;gap:20px;align-items:center;margin-bottom:38px;color:#91a5bd;font-size:12px}.mock-topbar strong{color:#eef5ff;font-size:15px}.mock-hero{display:flex;justify-content:space-between;align-items:end;gap:30px;margin:0 0 26px}.mock-hero p{color:#91a5bd;font-size:16px;margin:9px 0 0;max-width:600px}.mock-actions{display:flex;gap:10px}.mock-button{border:1px solid #263b55;border-radius:9px;padding:10px 15px;color:#eef5ff;background:#101d30;text-decoration:none;white-space:nowrap}.mock-button.primary{background:#55dfad;border-color:#55dfad;color:#06151a;font-weight:800}
...
.pulse-card:nth-child(4) .eyebrow{font-size:8.5px}.pulse-card:nth-child(4) .pulse-value{font-size:22px;font-weight:800}.pulse-card:nth-child(4) .muted{font-size:10.5px}.pulse-card:nth-child(4) .next-scan{display:block;color:#f4c95d;font-size:12px;font-weight:800;margin-top:8px}
.pulse-card:nth-child(-n+3) .eyebrow{font-size:8.5px}.pulse-card:nth-child(-n+3) .pulse-value{font-size:22px;font-weight:800}.pulse-card:nth-child(-n+3) .muted{font-size:10.5px}.pulse-card:nth-child(2) .pulse-value{line-height:1.35;max-width:210px}.pulse-card:nth-child(3) .pulse-value{line-height:1.1}
