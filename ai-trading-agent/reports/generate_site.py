...
.rotation-summary{margin-top:34px;padding:20px;border:1px solid #263b55;border-radius:15px;background:linear-gradient(145deg,#14253b,#101b2d)}.rotation-summary-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:24px}.rotation-mini-row{display:grid;grid-template-columns:110px 1fr 55px;gap:10px;align-items:center;padding:8px 0}.rotation-bar{height:8px;background:#263b55;border-radius:99px;overflow:hidden}.rotation-bar i{display:block;height:100%;background:#55dfad;border-radius:99px}.rotation-bar .downbar{background:#ff7780}.probable-rotation{padding:10px 0}.probable-rotation p{margin:10px 0}.rotation-summary-actions{margin-top:15px;text-align:right}.full-sector-analysis{margin-top:18px}.full-sector-analysis>details>summary{cursor:pointer;color:#83a9ff;font-weight:700;list-style:none;text-align:right}.full-sector-analysis>details>summary::-webkit-details-marker{display:none}.full-sector-analysis>details>summary:after{content:'  +';font-size:1.1em}@media(max-width:700px){.rotation-summary-grid{grid-template-columns:1fr}}
