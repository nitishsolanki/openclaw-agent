...
.mock-theme{color:#eef5ff}body{background:radial-gradient(circle at 78% -10%,#1e3b62 0,#08111f 42%);color:#eef5ff}main{max-width:1280px;padding:28px 24px 70px}header{margin-bottom:38px}.hero{display:flex;justify-content:flex-start;align-items:end;background:transparent;border:0;gap:30px}.hero>div{background:linear-gradient(145deg,rgba(20,37,59,.95),rgba(13,26,44,.95));border:1px solid #263b55;border-radius:15px;padding:18px;width:100%}.hero strong{font-size:1.2rem}.section-head{margin-bottom:15px}.section h2{font-size:18px;letter-spacing:-.02em}
