...
(() => {
  ...
  svg.insertAdjacentHTML('afterbegin', `<defs><marker id='arrow' markerWidth='8' markerHeight='8' refX='7' refY='3' orient='auto'><path d='M0,0 L0,6 L8,3 z' fill='#70d6c3'/></marker></defs>`);
    ...
    summary_table = "<div class='sector-summary-card'><div class='sector-summary-header'><b>Sector</b><span>Last 5 sessions</span><b>5D avg</b><b>20D avg</b><b>ETF Current Δ</b></div>" + ''.join(summary_rows) + "</div>"
